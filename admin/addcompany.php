...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="h-16 text-lg font-semibold lg:text-3xl">Company</h1> 
        ...
        <table class="min-w-full table-auto border-collapse">
          <thead>
            <tr class=" text-left text-base text-[#808185]">
              ...
              <th class="p-4">Company Reg. No.</th>
              <th class="p-4">Email Address</th>
              <th class="p-4">Hiring Position</th>
          ...
          <tbody class="text-base text-semibold">
            <tr class="border-b">
              ...
              <td class="p-4">Tech Innovators Inc.</td>
              <td class="p-4">123456789</td>
              <td class="p-4">contact@techinnovators.com</td>
              <td class="p-4">Software Engineer</td>
              <td class="p-4 flex space-x-2">
              <div>
                  <button id="viewCompanyDetailsBtn" class="text-black focus:outline-none">
                    <svg 
                      xmlns="http://www.w3.org/2000/svg" 
                      width="24" 
                      height="24" 
      ...
      <!----Modal--->
      <div id="addCompanyModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
        <div class =" w-[730px] h-[460px] bg-white rounded-[25px] shadow-[0_4px_10px_rgba(0,0,0,0.1)] border p-6 relative">
          <div class="text-[#424141] text-[36px] font-bold absolute top-6 left-6">
            Add Company 
          </div>

            <!-- Form -->
          <form class="my-24 space-y-6 px-10"> 
            <div class="grid grid-cols-3 gap-6">
              <div class="col-span-1">
                <label class="block text-base font-medium text-gray-700 my-0">Company Name</label>
              ...
              <div class="grid grid-cols-2 gap-6">
                <div class="col-span-1">
                  <label class="block text-base font-medium text-gray-700 my-0">Company Registration Number</label>
              ...
              <div class="grid grid-cols-2 gap-6">
                <div class="col-span-1">
                  <label class="block text-base font-medium text-gray-700 my-0">Memorandum of Aggrement (MoA)</label>
                  <button class="bg-[#3E3C3C] font-semibold text-white px-3 py-1 rounded-lg hover:bg-[#333333]">Upload</button>
                </div>
              </div>

              <div class="flex justify-end space-x-4 mt-4">
                <button id="closeModal"class="border border-[#3E3C3C] text-[#3E3C3C] font-semibold px-4 py-2 rounded-lg hover:bg-[#F0F0F0]"
                >
                Cancel
                </button>
                <button class="bg-[#1E1E1E] font-semibold text-white px-4 py-2 rounded-lg hover:bg-[#333333]"type="submit"
                >
                Submit
                </button>
              </div>
      ...
      <div id="companyDetailsModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
      <div class =" w-[730px] h-[400px] bg-white rounded-[25px] shadow-[0_4px_10px_rgba(0,0,0,0.1)] border p-6 relative">
          <div class="text-[#424141] text-[36px] font-bold absolute top-6 left-6">
            Company Details 
          </div>
          ...
          <div class="flex space-x-6 mt-16">
            ...
            <div class="flex-1">
              <div class="mt-6 text-[#000000] text-[24px] font-bold">The Zone Company</div>
                <div class="m-0">
                  <div class="text-[#000000] text-[16px]">
                    <span class="font-bold">Company Registration  No.:</span> 09288923
                  </div>
                </div>
                <div class="m-0">
                  <div class="text-[#000000] text-[16px]">
                    <span class="font-bold">Email Address:</span> thezonecompany@gmail.com
                  </div>
                </div>
                  <div class="m-0">
                    <div class="text-[#000000] text-[16px]">
                      <span class="font-bold">Hiring Positions:</span> Database Administrator
                    </div>
                  </div>
                  <div class="m-0">
                    <div class="text-[#000000] text-[16px]">
                  ...
                  <div class="grid grid-cols-2 gap-6">
                    <div class="m-0">
                      <div class="flex items-center space-x-4">
                        <div class="text-[#000000] text-[16px] font-bold">Moa:</div>
                        <button class="bg-[#3E3C3C] text-white font-semibold px-4 py-2 rounded-lg shadow-md">View</button>
                      </div>
                    </div>
                  </div>
            </div>
          ...
          <div class="flex justify-end space-x-4 mt-4">
            <button id="closeCompanyDetailsModal" class="border border-[#3E3C3C] text-[#3E3C3C] font-semibold px-4 py-2 rounded-lg">
              Cancel
            </button>
      ...
      <!---Update--->
      <div  id="companyModal" class="hide fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
          <div class="w-[776px] h-[450px] bg-white rounded-[25px] shadow-[0_4px_10px_rgba(0,0,0,0.1)] border p-6 relative">
            <div class="text-[#424141] text-[36px] font-bold absolute top-6 left-6">
            Update Company              
            </div>
          ...
          <form class="my-24 space-y-6 px-10"> 
            <div class="grid grid-cols-3 gap-6">
              ...
              <div class="flex justify-end space-x-4 mt-4">
                <button id="closeEditModal"class="border border-[#3E3C3C] text-[#3E3C3C] font-semibold px-4 py-2 rounded-lg hover:bg-[#F0F0F0]"
                >
                Cancel
                </button>
                <button class="bg-[#1E1E1E] font-semibold text-white px-4 py-2 rounded-lg hover:bg-[#333333]"type="submit"
      ...
      <div id="removeModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
        <div class="w-[717px] bg-white bg-opacity-90 backdrop-blur-md shadow-[0_4px_10px_rgba(0,0,0,0.1)] border p-6 rounded-[25px] relative flex flex-col justify-between">
            ...
            <div class="text-center text-[#424141] text-[24px] font-base pt-20 pb-12">
              Do you confirm to remove this Company?
            </div>
      ...
      <script>
        ...
        document
          ...
          document.addEventListener('DOMContentLoaded', () => {
            ...
            // Close modal
            closeCompanyDetailsModal.addEventListener('click', function () {
            ...
            // Update Modal
              ...
              const companyModal = document.getElementById('companyModal');  // Make sure this ID matches the modal in your HTML
              ...
              closeEditModal.addEventListener('click', (e) => {
                e.preventDefault();
                companyModal.classList.add('hidden');  // Close the correct modal
              });
