...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="h-16 text-lg font-semibold lg:text-3xl">OJT Coordinator</h1> 
      <div class="flex items-center justify-between w-full p-4">          
        <div class="text-lg font-medium">
          List of OJT Coordinators
        </div>
        <div class="flex-grow mx-4 flex justify-center">
          <input 
            class="w-[400px] border bg-[#EBE7E7] text-[#808185] rounded-lg font-semibold px-4 py-1.5 focus:outline-none"
            type="search" 
        ...
        <div>
          <button id="openModal" class="bg-[#1E1E1E] text-white px-4 py-2 rounded-lg ">
            + Add Coordinator
          </button> 
        </div>  
      </div>
        ...
        <table class="min-w-full table-auto border-collapse">
          <thead>
            <tr class=" text-left text-base text-[#808185]">
              ...
              <th class="p-4">Employee Number</th>
          ...
          <tbody class="text-base text-semibold">
            ...
            <td class="p-4">
              ...
              <td class="p-4">Ralph Omaña Canlas</td>
              <td class="p-4">987456</td>
              <td class="p-4">ojtcoordinator@gmail.com</td>
              <td class="p-4">Bachelor of Science in Information Technology</td></td>
              <td class="p-4 flex space-x-2">
                <div>
                  <button id="viewOjtcoorDetailsBtn" class="text-black focus:outline-none">
                    <svg 
                      xmlns="http://www.w3.org/2000/svg" 
                      width="24" 
                      height="24" 
                ...
                <div>
                  <button id="openEditModal" class="text-black focus:outline-none">
                ...
                <div>
                  <button id="openRemoveModal" class="text-black focus:outline-none">
                    <svg xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
      ...
      <!----Modal--->
      <div id="addOjtcoorModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
          <div class =" w-[730px] h-[512px] bg-white rounded-[25px] shadow-[0_4px_10px_rgba(0,0,0,0.1)] border p-6 relative">

            <div class="text-[#424141] text-[36px] font-bold absolute top-6 left-6">
            Add OJT Coordinator
            </div>
      
          <!--form-->
          <form class="my-24 space-y-6">
            <div class="grid grid-cols-3 gap-6">
              <div class="col-span-1">
                <label class="block text-base font-medium text-gray-700 my-0">First Name</label>
                <input type="text" class="w-full border rounded-[4px] bg-[#D9D9D9] px-4 py-1 focus:outline-none  focus:ring-1 focus:ring-blue-500"/>
              </div>
              <div class="col-span-1">
                <label class="block text-base font-medium text-gray-700 my-0">Middle Name</label>
                <input type="text" class="w-full border rounded-[4px] bg-[#D9D9D9] px-4 py-1 focus:outline-none"/>
              </div>
              <div class="col-span-1">
                <label class="block text-base font-medium text-gray-700 my-0">Last Name</label>
                <input type="text" class="w-full border rounded-[4px] bg-[#D9D9D9] px-4 py-1 focus:outline-none" />
              </div>
            </div>
            <div class="grid grid-cols-3 gap-6">
              <div class="col-span-1">
                <label class="block text-base font-medium text-gray-700 my-0">Password</label>
                <input type="password" class="w-full border rounded-[4px] bg-[#D9D9D9] px-4 py-1 focus:outline-none"/>
              </div> 
              <div class="col-span-2">
                <label class="block text-base font-medium text-gray-700 my-0">Employee Number</label>
                <input type="text" class="w-full border rounded-[4px] bg-[#D9D9D9] px-4 py-1 focus:outline-none"/>
              </div>
            </div>
            <div class="grid grid-cols-3 gap-6">
              <div class="col-span-3">
                <label class="block text-base font-medium text-gray-700 my-0">Email Address</label>
                <input type="email" class="w-full border rounded-[4px] bg-[#D9D9D9] px-4 py-1 focus:outline-none"/>
              </div>
            </div>
            <div class="grid grid-cols-3 gap-6">
              <div class="col-span-3">
                <label class="block text-base font-medium text-gray-700 my-0">Department</label>
                <input type="text" class="w-full border rounded-[4px] bg-[#D9D9D9] px-4 py-1 focus:outline-none" />
              </div>
            </div>
            <div class="flex justify-end space-x-4 mt-4">
              <button id="closeModal"class="border border-[#3E3C3C] text-[#3E3C3C] font-semibold px-4 py-2 rounded-lg hover:bg-[#F0F0F0]">Cancel</button>
              <button class="bg-[#1E1E1E] font-semibold text-white px-4 py-2 rounded-lg hover:bg-[#333333]"
      ...
      <!--view-->
      <div id="OjtcoorDetailsModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
        <div class =" w-[717px] h-[380px] bg-white rounded-[25px] shadow-[0_4px_10px_rgba(0,0,0,0.1)] border p-6 relative">
          <div class="text-[#424141] text-[36px] font-bold absolute top-6 left-6">
            Coordinator Details
          </div>

          <div class="flex space-x-6 mt-16">
            <div class="mt-6 w-[158px] h-[150px] bg-gray-200 rounded-lg flex items-center justify-center">
              <img src="" alt="" class="w-full h-full object-contain">
            </div>
            <div class="flex-1">
              <div class="mt-6 text-[#000000] text-[24px] font-bold">Ralph Omaña Canlas</div>
                <div class="m-0">
                  <div class="text-[#000000] text-[16px]">
                    <span class="font-bold">Employee No:</span> 234262
                  </div>
                </div>
                <div class="m-0">
                  <div class="text-[#000000] text-[16px]">
                    <span class="font-bold">Email Address:</span> ojtcoordinator@gmail.com
                  </div>
                </div>
                  <div class="m-0">
                    <div class="text-[#000000] text-[16px]">
                      <span class="font-bold">Department:</span> Bachelor of Science in Information technology
                    </div>
                  </div>
                  <div class="m-0">
                    <div class="text-[#000000] text-[16px]">
                      <span class="font-bold">Phone Number:</span> 09496813758
                    </div>
                  </div>
            </div>
            </div>
            <div class="flex justify-end space-x-4 mt-6">
              <button id="closeOjtcoorDetailsModal" class="border border-[#3E3C3C] text-[#3E3C3C] font-semibold px-4 py-2 rounded-lg">
                Cancel
              </button>
              <button type="" class="bg-[#3E3C3C] text-[#FFFFFF] font-semibold px-8 py-2 rounded-lg">
                OK
              </button>
            </div>
        </div>
      ...
      <!---Update--->
      <div  id="OjtcoorModal" class="hide fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
          <div class="w-[730px] h-[512px] bg-white rounded-[25px] shadow-[0_4px_10px_rgba(0,0,0,0.1)] border p-6 relative">
            <div class="text-[#424141] text-[36px] font-bold absolute top-6 left-6">
        ...
        <!--form-->
          ...
          <div class="flex justify-end space-x-4 mt-6">
            <button id="closeEditModal"class="border border-[#3E3C3C] text-[#3E3C3C] font-semibold px-4 py-2 rounded-lg hover:bg-[#F0F0F0]">Cancel</button>
            <button class="bg-[#1E1E1E] font-semibold text-white px-4 py-2 rounded-lg hover:bg-[#333333]"
              type="submit">Submit</button>                
          </div>
          </form>
      ...
      <!--Drop Modal-->
      <div id="removeModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
        <div class="w-[717px] bg-white bg-opacity-90 backdrop-blur-md shadow-[0_4px_10px_rgba(0,0,0,0.1)] border p-6 rounded-[25px] relative flex flex-col justify-between">
            <div class="text-[#424141] text-[36px] font-bold absolute top-6 left-6">
              Remove OJT Coordinator
            </div>

            <div class="text-center text-[#424141] text-[24px] font-base pt-20 pb-12">
              Do you confirm to remove this OJT Coordinator?
            </div>

            <div class="flex justify-end space-x-4 my-0">
              <button id="closeRemoveModal" class="border border-[#3E3C3C] text-[#3E3C3C] font-semibold px-4 py-2 rounded-lg hover:bg-[#F0F0F0]">
              Cancel
              </button>
              <button class="bg-[#D11B1B] text-white font-semibold px-4 py-2 rounded-lg hover:bg-[#b31818]">
                Remove
              </button>
            </div>
          </div>
        ...
        <script>
          ...
          document
            ...
            document.addEventListener('DOMContentLoaded', () => {
              ...
              const addOjtcoorModal = document.getElementById('addOjtcoorModal');

            // Open modal
                openModalButton.addEventListener('click', () => {
                addOjtcoorModal.classList.remove('hidden');
                });

            // Close modal
                closeModalButton.addEventListener('click', () => {
                addOjtcoorModal.classList.add('hidden');
                });

            // Close modal on overlay click
                addOjtcoorModal.addEventListener('click', (event) => {
                if (event.target === addOjtcoorModal) {
                addOjtcoorModal.classList.add('hidden');
                }
                });

            // Form submission
                const addOjtcoorForm = document.getElementById('addOjtcoorForm');
                addOjtcoorForm.addEventListener('submit', (event) => {
                event.preventDefault();
            // Add logic to handle form submission
                onsole.log('OJT Coordinator added');
                addOjtcoorModal.classList.add('hidden');
              });
              });
 
            // View Modal
              const viewOjtcoorDetailsBtn = document.getElementById('viewOjtcoorDetailsBtn');
              const OjtcoorDetailsModal = document.getElementById('OjtcoorDetailsModal');
              const closeOjtcoorDetailsModal = document.getElementById('closeOjtcoorDetailsModal');

            // Open modal
              viewOjtcoorDetailsBtn.addEventListener('click', function () {
                OjtcoorDetailsModal.classList.remove('hidden');
              });

            // Close modal
              closeOjtcoorDetailsModal.addEventListener('click', function () {
                OjtcoorDetailsModal.classList.add('hidden');
              });

            // Close the modal if user clicks outside the modal box
              OjtcoorDetailsModal.addEventListener('click', function (e) {
                if (e.target === OjtcoorDetailsModal) {
                  OjtcoorDetailsModal.classList.add('hidden');
                }
              });
            ...
            // Update Modal
              ...
              const OjtcoorModal = document.getElementById('OjtcoorModal');  

              // Open Modal
              openEditModal.addEventListener('click', () => {
                OjtcoorModal.classList.remove('hidden');
              });

              // Close Modal
              closeEditModal.addEventListener('click', (e) => {
                e.preventDefault();
                OjtcoorModal.classList.add('hidden');  // Close the correct modal
              });
