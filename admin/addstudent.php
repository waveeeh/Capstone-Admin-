...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="h-16 text-lg font-semibold lg:text-3xl">Students</h1>
      ...
      <div class="max-screen mx-auto mt-8 bg-[#FDFDFD] drop-shadow-lg p-6 rounded-lg">
        <table class="min-w-full table-auto border-collapse">
          ...
          <tbody class="text-base text-semibold">
            ...
            <td class="p-4">Clarence Ariel V. Pamilar</td>
            <td class="p-4">SUM2021-01636</td>
            <td class="p-4">Clarencesk8@gmail.com</td>
            <td class="p-4">Bachelor of Science in Information Technology</td></td>
            <td class="p-4 flex space-x-2">
              <div>
                <button class="text-black focus:outline-none" id="viewStudentDetailsBtn">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
        ...
        <!----Modal--->
        <div id="addStudentModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
              ...
              <div class="grid grid-cols-3 gap-6">
                ...
                <div class="grid grid-cols-3 gap-6">
                  <div class="col-span-1">
                    ...
                    <input type="password" class="w-full border rounded-[4px] bg-[#D9D9D9] px-4 py-1 focus:outline-none  focus:ring-1 focus:ring-blue-500"/>
                </div>
                <div class="col-span-1">
                    <label class="block text-base font-medium text-gray-700 my-0">Student Number</label>
                    <input type="text" class="w-full border rounded-[4px] bg-[#D9D9D9] px-4 py-1 focus:outline-none"/>
                </div>
                  <div class="col-span-1">
                    <label class="block text-base font-medium text-gray-700 my-0">Course & Section</label>
                    <input type="text" class="w-full border rounded-[4px] bg-[#D9D9D9] px-4 py-1 focus:outline-none" />
                  </div>
                </div>
                <div class="grid grid-cols-3 gap-6">
                ...
                <div class="flex justify-end space-x-4 mt-6">
                  <button id="closeModal" class="border border-[#3E3C3C] text-[#3E3C3C] font-semibold px-4 py-2 rounded-lg hover:bg-[#F0F0F0]">Cancel
                  </button>
                  <button class="bg-[#1E1E1E] font-semibold text-white px-4 py-2 rounded-lg hover:bg-[#333333]">Submit</button>
                </div>
            </form>
          </div>
        </div>
        ...
        <!--view-->
        <div id="studentDetailsModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
          <div class =" w-[717px] h-[400px] bg-white rounded-[25px] shadow-[0_4px_10px_rgba(0,0,0,0.1)] border p-6 relative">
            <div class="text-[#424141] text-[36px] font-bold absolute top-6 left-6">
              Student Status
            </div>
            ...
            <div class="flex space-x-6 mt-16">
              ...
              <div class="flex-1">
                <div class="mt-6 text-[#000000] text-[24px] font-bold">Clarence Ariel V. Pamilar</div>
                  <div class="m-0">
                    <div class="text-[#000000] text-[16px]">
                      <span class="font-bold">Student No.:</span> SUM2021-01636
                    </div>
                  </div>
                <div class="m-0">
                  <div class="text-[#000000] text-[16px]">
                    <span class="font-bold">Section:</span> BSIT 4-G
                  </div>
                </div>
                  <div class="m-0">
                    <div class="text-[#000000] text-[16px]">
                      <span class="font-bold">Birthdate:</span> 08/24/01
                    </div>
                  </div>
                  <div class="m-0">
                    <div class="text-[#000000] text-[16px]">
                  ...
                  <div class="m-0">
                    <div class="text-[#000000] text-[16px]">
                      <span class="font-bold">Trainer:</span> Andrew J. Villena
                    </div>
                  </div>
                  <div class="m-0">
                    <div class="text-[#000000] text-[16px]">
                      <span class="font-bold">Status:</span> Deployed
                    </div>
                  </div>
              </div>
              </div>
              <div class="flex justify-end space-x-4 mt-6">
                <button id="closeStudentDetailsModal" class="border border-[#3E3C3C] text-[#3E3C3C] font-semibold px-4 py-2 rounded-lg">
                  Cancel
                </button>
          ...
          <!---Update--->
          <div  id="StudModal" class="hide fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
            <div class="w-[730px] h-[512px] bg-white rounded-[25px] shadow-[0_4px_10px_rgba(0,0,0,0.1)] border p-6 relative">
              <div class="text-[#424141] text-[36px] font-bold absolute top-6 left-6">
                Update Student
              </div>
        ...
        <div id="removeModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
          <div class="w-[717px] bg-white bg-opacity-90 backdrop-blur-md shadow-[0_4px_10px_rgba(0,0,0,0.1)] border p-6 rounded-[25px] relative flex flex-col justify-between">
            ...
            <div class="text-center text-[#424141] text-[24px] font-base pt-20 pb-12">
              Do you confirm to remove this Student?
            </div>
            ...
            function hideDropdown() {
              ...
              document
                ...
                // Add logic to handle form submission
                  onsole.log('Student added');
                  addStudentModal.classList.add('hidden');
                });
                });

                // View Modal
                const viewStudentDetailsBtn = document.getElementById('viewStudentDetailsBtn');
                const studentDetailsModal = document.getElementById('studentDetailsModal');
                const closeStudentDetailsModal = document.getElementById('closeStudentDetailsModal');

                // Open modal
                viewStudentDetailsBtn.addEventListener('click', function () {
                  studentDetailsModal.classList.remove('hidden');
                });

                // Close modal
                closeStudentDetailsModal.addEventListener('click', function () {
                ...
                // Update Modal
                  ...
                  const studModal = document.getElementById('StudModal');
                // Open Modal
