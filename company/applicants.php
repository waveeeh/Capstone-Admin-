  ...
  <main class="max-w-[1920px] mt-2 lg:ml-52 md:ml-52 p-4">
    <div>
      <div class="w-[350px] relative">
        <input class="border w-full pl-10 pr-3 py-1" type="search" placeholder="Search for applicants" name="" id="" />
      ...
      <div class="w-full grid items-center justify-evenly mx-auto mt-5 grid-cols-4 gap-5">
        <div class="w-full flex flex-col border border-black p-2 gap-4 rounded-md">
          <div class="w-full flex flex-row gap-1">
            <div>
              <img src="../img/Group 136.png" alt="" class="w-[50px] h-[50px]" />
            </div>
            <div>
          ...
          <div class="flex flex-wrap w-full gap-2">
            <div class="bg-button h-6 rounded flex items-center justify-center px-2">
            ...
            <div class="bg-button h-6 rounded col-span-2 flex items-center justify-center px-2">
          ...
          <div class="flex flex-row justify-between">
            <button class="change-photo px-2 py-1 text-sm rounded-sm font-medium">
              View profile</button><button class="remove-photo px-2 py-1 rounded-sm text-sm font-medium">
              Accept student
            </button>
          </div>
        </div>
