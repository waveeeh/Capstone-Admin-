  ...
  <main class="max-w-[1920px] mt-2 lg:ml-52 md:ml-52 p-4">
    <form method="post" action="update_profile.php" class="flex flex-col items-center w-full" id="form"
      ...
      <div class="flex flex-col lg:flex-row mt-5 items-center w-full gap-5">
        <div class="flex flex-col items-center gap-5 lg:flex-row w-full">
          ...
          <div class="flex flex-col">
            <label for="photo" class="font-medium text-base">User Photo</label>
        ...
        <div class="flex flex-col items-center gap-5 lg:flex-row w-full">
          <div>
            <img
              ...
              alt="Company Logo" class="w-32 h-32 rounded-full object-cover" />
          </div>
          <div class="flex flex-col">
            <label for="CompanyLogo" class="font-medium text-base">Company Logo</label>
      ...
      <div class="w-full flex flex-col lg:flex-col gap-2">
        ...
        <div>
          <label for="website" class="font-medium text-sm">Website(Optional)</label>
          <input name="Website" type="text" value="<?php echo htmlspecialchars($company['Website']); ?>"
            class="px-2 h-8 border w-full rounded-md focus:outline-none focus:border-black" />
        </div>
