        ...
        <div class="p-5 flex flex-col gap-4">
          <div class="flex flex-row w-full gap-10">
            <div class="flex flex-col w-full">
              <label for="" class="text-lg">Position</label><input name="position" type="text"
                class="w-full h-8 custom-inborder rounded-md" />
            </div>
            <div class="flex flex-col w-full">
              <label for="" class="text-lg">Street</label><input name="Street" type="text"
                class="w-full h-8 custom-inborder rounded-md" />
            </div>
          </div>
          <div class="flex flex-row w-full gap-10">
            <div class="flex flex-col w-full">
              <label for="" class="text-lg">Barangay</label><input name="Barangay" type="text"
                class="w-full h-8 custom-inborder rounded-md" />
            </div>
            <div class="flex flex-col w-full">
              <label for="" class="text-lg">City/Town</label><input name="City" type="text"
                class="w-full h-8 custom-inborder rounded-md" />
            </div>
          </div>
          <div class="flex flex-row w-full gap-10">
            <div class="flex flex-col w-full">
              <label for="" class="text-lg">Province</label><input name="Province" type="text"
                class="w-full h-8 custom-inborder rounded-md" />
            </div>
            <div class="flex flex-col w-full">
              <label for="" class="text-lg">Available Slots</label><input name="NoOfOpenings" type="number"
                class="w-full h-8 custom-inborder rounded-md" />
            </div>
          </div>
          ...
          <div class="flex flex-row w-full gap-10">
            <div class="flex flex-col w-full">
              ...
              <select name="course" id="" class="w-full h-8 custom-inborder rounded-md">
                <?php
                $courses = [
            ...
            <div class="flex flex-col w-full">
              <label for="" class="text-lg">Monthly allowance(Optional)</label><input name="allowance" type="text"
                class="w-full h-8 custom-inborder rounded-md" />
            </div>
          </div>
          <div class="flex flex-row w-full gap-10">
            <div class="flex flex-col w-full">
              <label for="" class="text-lg">Start date</label><input name="startDate" type="date"
                class="w-full h-8 custom-inborder rounded-md" />
            </div>
            <div class="flex flex-col w-full">
              <label for="" class="text-lg">End date</label><input name="endDate" type="date"
                class="w-full h-8 custom-inborder rounded-md" />
            </div>
          </div>
          <div class="dropdown">
          ...
          <div class="w-full">
            <label for="" class="text-lg">Job description</label><textarea name="Description" id=""
              class="w-full min-h-20 custom-inborder rounded-md"></textarea>
          </div>
