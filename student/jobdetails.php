...
if ($jobId > 0) {
  // Prepare SQL query to fetch job, company, and location details
  $sql = "
        SELECT j.jobId, j.position, j.Description, j.NoOfOpenings, j.startDate, j.endDate,
               c.companyName, c.companyLogo, c.website,
               l.street, l.barangay, l.city, l.province
        FROM job j
...
<body>
    ...
    <div class="flex flex-row gap-5">
      ...
      <div class="relative custom-profile flex flex-row items-center cursor-pointer">
        ...
        <div id="custom-dropdownMenu"
          ...
          <a href="#" class="custom-block px-4 py-2 text-gray-700 hover:bg-gray-100">Logout</a>
        </div>
      </div>
    </div>
  </nav>
  ...
  <main class="lg:ml-52 md:ml-52 py-2 px-3 mx-auto flex flex-col gap-5 max-w-[1920px]">
    <div class="w-full">
      <h1 class="text-xl font-semibold">Job Details</h1>
      <div class="hr w-full"></div>
    </div>
    <?php if (isset($jobDetails) && !empty($jobDetails)): ?>
      <div class="flex lg:flex-row flex-col gap-4">
        <div class="w-full lg:w-[70%] flex flex-col gap-4">
          <div class="flex flex-col gap-2 w-full">
            <div class="w-full flex flex-row justify-between">
              <h1 class="text-2xl font-semibold"><?php echo ucfirst($position) ?></h1>
            ...
            <div class="flex w-full items-center">
              <div class="w-full gap-4 flex flex-row items-center">
                <img src="../images/<?php echo htmlspecialchars($companyLogo); ?>"
                  alt="<?php echo htmlspecialchars(ucfirst($companyName)); ?>" class=" rounded-full w-[100px] h-full" />
                <ul class="flex flex-col gap-1">
                  <li class="flex flex-row items-center gap-1">
                    <svg width="16" height="16" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0_113_107)">
                        ...
                        <path
                          ...
                          stroke="black" stroke-width="0.666667" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M5 3H7" stroke="black" stroke-width="0.666667" stroke-linecap="round"
                          stroke-linejoin="round" />
                        <path d="M5 5H7" stroke="black" stroke-width="0.666667" stroke-linecap="round"
                          stroke-linejoin="round" />
                        <path d="M5 7H7" stroke="black" stroke-width="0.666667" stroke-linecap="round"
                          stroke-linejoin="round" />
                        <path d="M5 9H7" stroke="black" stroke-width="0.666667" stroke-linecap="round"
                          stroke-linejoin="round" />
                      </g>
                      <defs>
                    ...
                    <span class="font-light text-sm lg:text-xs"><?php echo ucfirst($companyName) ?></span>
                  </li>
                  <li class="flex flex-row items-center gap-1">
                    <svg width="16" height="16" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                    ...
                    <span class="font-light text-sm lg:text-xs"><?php echo ucfirst($location) ?></span>
                  </li>
                  <li class="flex flex-row items-center gap-1">
                    <svg width="16" height="16" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                    ...
                    <span class="font-light text-sm lg:text-xs"><?php echo $openings ?> Available</span>
                  </li>
                </ul>
              </div>
            </div>
          </div>
          <div class="min-h-32 w-full overflow-auto">
          ...
          <div>
            <h1><b> Start Date: <?php echo $startDate ?></b></h1>
            <h1><b>End Date: <?php echo $endDate ?> </b></h1>
          </div>
        </div>
      <?php else: ?>
        <p>Job details not available.</p>
      <?php endif; ?>
      <div class="flex flex-col lg:w-[30%] w-full overflow-y-auto max-h-screen">
        ...
        <div class="w-full min-h-44 rounded-lg card flex flex-col gap-1 p-1">
          <div id="" class="colorCard flex flex-col gap-2 card p-2 rounded-md">
            <div class="flex flex-row items-center justify-center">
              ...
              <div class="w-[20%] flex items-center">
                <img src="./img/LinkedIn_logo_initials.png" alt="" class="w-[40px] h-[40px] rounded-full" />
              </div>
            </div>
              ...
              <div class="">
                <ul class="flex flex-col gap-1">
                  <li class="flex flex-row items-center gap-1">
                    ...
                    <span class="font-light text-[10px] lg:text-xs">LinkedIn</span>
                  </li>
                  <li class="flex flex-row items-center gap-1">
                    <svg width="14" height="14" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                    ...
                    <span class="font-light text-[10px] lg:text-xs">Cabanatuan City</span>
                  </li>
                  <li class="flex flex-row items-center gap-1">
                    <svg width="14" height="14" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                    ...
                    <span class="font-light text-[10px] lg:text-xs">2 Available</span>
                  </li>
                </ul>
              </div>
              <div class="">
                <ul class="flex gap-1 flex-col">
                  <li class="text-xs text-center border border-gray-800 px-0.5 rounded-lg">
                    Creative
                  </li>
                  <li class="text-xs text-center border border-gray-800 px-0.5 rounded-lg">
                    Figma
          ...
          <div class="">
            <button class="text-xs bg-black text-white py-1 px-3 rounded-md font-semibold">
              Details
            </button>
          </div>
        </div>
